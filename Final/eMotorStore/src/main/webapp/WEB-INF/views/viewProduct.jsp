...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Here is the detail information of the Tour!
            </p>
        </div>
        ...
        <div class="container" ng-app = "cartApp">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p>
                       <strong>Duration</strong> : ${product.productManufacturer}
                    </p>
                    <p>
                        <strong>Category</strong> : ${product.productCategory}
                    </p>
                    <p>
                        <strong>Available this Month</strong> : ${product.productCondition}
                    </p>
