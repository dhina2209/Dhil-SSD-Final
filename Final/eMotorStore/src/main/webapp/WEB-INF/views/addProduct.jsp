...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Fill the below information to add a Tour:</p>
        </div>

        <form:form action="${pageContext.request.contextPath}/admin/product/addProduct" method="post"
                   commandName="product" enctype="multipart/form-data">
        <div class="form-group">
            <label for="name">Tour Name</label> <form:errors path="productName" cssStyle="color: #ff0000;" />
        ...
        <div class="form-group">
            <label for="unitInStock">Starting Date</label>  <form:errors path="unitInStock"
